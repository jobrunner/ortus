...
## [2.0.1](https://github.com/jobrunner/ortus/compare/v2.0.0...v2.0.1) (2026-09-14)


### Bug Fixes

* **cors:** warn about an allow-list scheme no browser sends ([32ceebf](https://github.com/jobrunner/ortus/commit/32ceebf4f170128767d7247b2536ef6d3bf06cbe))
* **cors:** warn about an allow-list scheme no browser sends ([c6087cc](https://github.com/jobrunner/ortus/commit/c6087cce01870a036a49b4f7d3e52b84abe718ba))

## [2.0.0](https://github.com/jobrunner/ortus/compare/v1.10.1...v2.0.0) (2026-09-13)
...
* **cors:** refuse the opaque "null" origin with its own reason ([e1d7e80](https://github.com/jobrunner/ortus/commit/e1d7e804907b4c63b74aaf0be99da4fc11637dc5))
* **cors:** reject empty-base wildcards, fix the shipped example ([636df75](https://github.com/jobrunner/ortus/commit/636df751f2674ab80424a602526698bf7aaeaa8b))
...
* **http:** deliver long batch responses instead of cutting them at write_timeout ([fc25219](https://github.com/jobrunner/ortus/commit/fc25219204039f3e51c5fb4c1d68c32e5168eef9))
* **http:** log a failed write-deadline lift, keep fast batch errors protected ([1d0fa49](https://github.com/jobrunner/ortus/commit/1d0fa492ed0b53b4cb52be551eff92f53e591a32))

## [1.9.2](https://github.com/jobrunner/ortus/compare/v1.9.1...v1.9.2) (2026-09-05)


### Bug Fixes

* **gazetteer:** make wide-radius candidate gathering batch-viable ([febbf04](https://github.com/jobrunner/ortus/commit/febbf04499a66c51d53d62fef0f339ec03e5d5bf))
...
* **mcp:** serve streamable HTTP statelessly to stop session leak ([4c2f9e6](https://github.com/jobrunner/ortus/commit/4c2f9e6376f384142bd18bc00bbdacfbff979bb6), [#180](https://github.com/jobrunner/ortus/pull/180))
...
* drop stale action version from comment; guard against comment drift ([a818bc2](https://github.com/jobrunner/ortus/commit/a818bc2475a5af6ae282822d8c7e13ffc83c6be4))
